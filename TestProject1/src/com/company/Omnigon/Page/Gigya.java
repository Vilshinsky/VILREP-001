...
public class Gigya {
    ...
    public static void newAccount() {
        ...
        TestHelper.waitElementByXpath("//*[@id='submitFavoritePlayer']").click();
        TestHelper.waitElementByXpath("//*[contains(@class,'user-menu')]");
        TestHelper.waitSec(3);
    }
    ...
    public static void goToAuthorization() {
        ...
        TestHelper.waitElementByCss(".login-button.log-in").click();
    }

    public static void goToRegistrationStep1() {
        goToAuthorization();
        TestHelper.waitElementByXpath("//*[@id='gigya-login-screen']//a[text()='Click here ']")
                .click();
    }
    public static void fillRegistrationForm() {
        TestHelper.waitElementByXpath("//*[@id='gigya-register-screen']//input[@name='email']")
                .sendKeys(newLogin);
        TestHelper.waitElementByXpath("//*[@id='gigya-register-screen']//input[@name='profile.firstName']")
                .sendKeys("Firstname");
        TestHelper.waitElementByXpath("//*[@id='gigya-register-screen']//input[@name='profile.lastName']")
                .sendKeys("Lastname");
        TestHelper.waitElementByXpath("//*[@id='gigya-register-screen']//input[@name='password']")
                .sendKeys("123123123");
        TestHelper.waitElementByXpath("//*[@id='gigya-register-screen']//input[@name='passwordRetype']")
                .sendKeys("123123123");
        TestHelper.waitElementByXpath("//*[@id='gigya-register-screen']//input[@name='data.terms']")
                .click();
    ...
    public static void goToRegistrationStep2() {
        ...
        TestHelper.waitElementByXpath("//*[@id='gigya-r-form1']//span[@class='gigya-input-button blue right']")
                .click();
    }
    public static void goToRegistrationStep3() {
        goToRegistrationStep2();
        TestHelper.waitElementByXpath("//*[@id='gigya-r-form2']//span[@class='gigya-input-button blue right']")
                .click();
    }
    public static void addStuartAppleby() {
        ...
        TestHelper.waitElementByXpath("//*[@id='addPlayerButton']").click();
    }
    ...
    public static boolean checkThatRegistrationStep2Blocked() {
        if(TestHelper.waitElementByXpath
    ...
    public static void passAuthorization() {
        goToAuthorization();
        TestHelper.waitElementByXpath("//*[@id='gigya-login-form']//input[@name='username']")
                .sendKeys(newLogin);
        TestHelper.waitElementByXpath("//*[@id='gigya-login-form']//input[@name='password']")
                .sendKeys("123123123");
        TestHelper.waitElementByXpath("//*[@id='gigya-login-form']//input[@class='gigya-input-submit']")
                .click();
    }
    public static void logOutFromDropdown() {
        ...
        TestHelper.waitSec(1);
        TestHelper.waitElementByXpath("//a[@data-action='logout']").click();
    }
    public static void logOutFromProfile() {
        TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']/div[1]/a[5]").click();
    }
    ...
    public static String regForm1Title1() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form1']/div/label[1]")
                .getText();
    }
    public static String regForm1Title2() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form1']/div/label[2]")
                .getText();
    }
    public static String regForm1Title3() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form1']/div/label[3]")
                .getText();
    }
    public static String regForm2Title1() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form2']/div/label[1]")
                .getText();
    }
    public static String regForm2Title2() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form2']/div/label[2]")
                .getText();
    }
    public static String regForm2Title3() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form2']/div/label[3]")
                .getText();
    }
    public static String regForm3Title1() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form3']/div/label[1]")
                .getText();
    }
    public static String regForm3Title2() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form3']/div/label[2]")
                .getText();
    }
    public static String regForm3Title3() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form3']/div/label[3]")
                .getText();
    }
    public static String regForm3Title4() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form3']/div/div[1]/*[contains(@class,'gigya-composite-control')][1]")
                .getText();
    }
    public static String regForm3Title5() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form3']/div/div[1]/*[contains(@class,'gigya-composite-control-dropdown')]//span")
                .getText();
    }
    public static String regForm3Title6() {
        return TestHelper.waitElementByXpath("//*[@id='myFavoritePlayersList']")
                .getText();
    }

    public static String regForm3Title7() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form3']/div[2]/div[2]/div[1]")
                .getText();
    }
    public static String regForm3Title8() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form3']//div[contains(@class,'gigya-composite-control-textbox')]//span")
                .getText();
    }
    public static String regForm3Title9() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-r-form3']//div[@class='gigya-layout-cell']/div[3]//span")
                .getText();
    }
    public static String profileFavoriteTitle1() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']//a[1]")
                .getText();
    }
    public static String profileFavoriteTitle2() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']//a[2]")
                .getText();
    }
    public static String profileFavoriteTitle3() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']//a[3]")
                .getText();
    }
    public static String profileFavoriteTitle4() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']//a[4]")
                .getText();
    }
    public static String profileFavoriteTitle5() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']//a[5]")
                .getText();
    }
    public static String profileFavoriteTitle6() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']/div/div[1]/*[contains(@class,'gigya-composite-control')][1]")
                .getText();
    }
    public static String profileFavoriteTitle7() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']/div/div[1]/*[contains(@class,'gigya-composite-control-dropdown')]//span")
                .getText();
    }
    ...
    public static String profileFavoriteTitle9() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']/div[2]/div[2]/div[1]")
                .getText();
    }
    public static String profileFavoriteTitle10() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']//div[contains(@class,'gigya-composite-control-textbox')]//span")
                .getText();
    }
    public static String profileFavoriteTitle11() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-profile-form3']//div[@class='gigya-layout-cell']/div[3]//span")
                .getText();
    }

    //GETTING VALUES
    public static String checkLoginTitle() {
        return TestHelper.waitElementByXpath("//div[text()='Login']")
                .getText();
    }
    public static String checkLoginSubTitle1() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-login-screen']//*[text()='Login with your social network:']")
                .getText();
    }
    public static String checkLoginSubTitle2() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-login-screen']//*[text()='Or, login here:']")
                .getText();
    }
    public static String checkEmailTitle() {
        return TestHelper.waitElementByXpath("//*[@id='gigya-login-screen']//*[text()='Email:']")
                .getText();
    }
    public static String checkRegistrationTitle() {
        return TestHelper.waitElementByXpath("//div[@class='gigya-screen-dialog-top']//div[text()='Registration']")
                .getText();
    }
